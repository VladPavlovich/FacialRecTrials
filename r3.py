...
mqtt_client = mqtt.Client(mqtt_client.CallbackAPIVersion.VERSION1, "RaspberryPi")
...
while typedkey == "":
    ...
    try:
        ...
        for face_loc, name in zip(face_locations, face_names):
            ...
            end_time = time.time()
            print(
                f"Recognized: {name}, time elapsed: {end_time - start_time}")  # Print the recognized name to the terminal
